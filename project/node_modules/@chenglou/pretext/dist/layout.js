...
installHideHorseAscii();
installSmoothHorizontalScroll();

function installHideHorseAscii() {
  if (typeof window === 'undefined' || typeof document === 'undefined') return;
  if (document.getElementById('zaydan-hide-horse-ascii')) return;
  ...
  function addStyle() {
    ...
    const horse = document.getElementById('horse-canvas');
    if (horse) {
